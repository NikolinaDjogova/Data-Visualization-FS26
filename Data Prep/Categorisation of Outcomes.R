...
Outcome_Categories_Global_Protest <- Global_Protest %>%
  ...
  str_detect(Outcomes, regex("resigned|ousted|fled|overthrown|coup|impeached|removed from office|stepped down|dismissed|fired|forced out|no confidence|cabinet resigned|government resigned|prime minister resigned|president resigned|expel|dissolv|new government|coalition government|tasked.*form|constitution was suspended|general.*in charge|military initiated|sworn into office|veto|ceasefire", ignore_case = TRUE)) ~ "Leadership Change",
  ...
  str_detect(Outcomes, regex("promised|investigation|delayed|postponed|reduced|increased funding|pay raise|bonus|subsidies|compensation|amended|reformed|committee|task force|commission|partially|announced measures|agreed to meet|agreed to consider|approved legislation|relief package|tax break|tax relief|salary|wage|job creation|hiring|extended the deadline|roundtable|plan|apologi|acknowledg|pledged|proposed|passed a law|passed a bill|approved the bill|approved the amendment|approved measures|legal reforms|hard deadline|suspended the tax|special budget|limited concession|sent the law back|negotiated settlement|court ruled|constitutional court|supreme court|electoral tribunal|parliament voted|lawmakers approved|congress voted|senate approved|mass release|protocols|death penalty|referendum", ignore_case = TRUE)) ~ "Partial Concession",
  str_detect(Outcomes, regex("killed|arrested|tear gas|water cannon|state of emergency|banned|internet shutdown|crackdown|detained|fired on protesters|opened fire|suppressed|deployed troops|deployed military|riot police|violently repressed|disperse|custody|charged|expelled|blocked|ethnic violence|rocket attacks|military operation|recalled its ambassador", ignore_case = TRUE)) ~ "Violent Suppression",
  str_detect(Outcomes, regex("No policy/leadership change|No policy or leadership change|No policy/leadership\\.|thanked the residents|sparked an international|Erdogan made explicitly clear|Houthi leaders implemented|opposition continued to protest|allow his party to attempt", ignore_case = TRUE)) ~ "No Change",
